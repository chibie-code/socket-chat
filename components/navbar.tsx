    ...
    <section style={styles.section}>
      <div style={styles.navBarContainer}>
        <span style={styles.navBar}>
          ...
          <span style={styles.onlineUsersContainer}>
              <p style={styles.onlineUsersNumber}>44,000+ <span style={styles.onlineUsersText}>online now</span></p>
          </span>
        </span>
      </div>
      {children}
